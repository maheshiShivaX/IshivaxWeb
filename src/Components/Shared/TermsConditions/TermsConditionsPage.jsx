                        ...
                        <div className="content-under-image">
                                ...
                                <div className="fw-container ">
                                    ...
                                    <div className="fw-col-md-4">
                                        <div className="fw-heading fw-heading-h2">
                                            <h2 className='fw-special-title vector-heading'>terms & Conditions
                                            </h2>
                                        </div>
                                    </div>
                                    <div className="fw-col-md-4  vector-class">
                            ...
                            <div className="fw-row">
                                <div className="container">
                                    ...
                                    <div className="fw-col-xs-12 ">
                                        <p className="heading-common-main">ishivax Terms & Condition</p>
                                        <p className="heading-common-content privacy_top_content">These Terms of Service ("Terms") govern your use of our website and services (referred to as "Website"). By accessing or using the Website, you agree to comply with these Terms.
                                        </p>
                                    </div>
                                    <div className="fw-col-xs-12 ">
