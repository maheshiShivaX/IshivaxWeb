...
const ProductPortfolioPage = () => {
    ...
    return (
        <div>
            <Header />
            <section>
                <div class="fw-main-row black-bg-content">
                    <div class="fw-full-container-top" style={{ backgroundImage: 'url(./images/bg-dots.png)' }}>
                        ...
                        <div class="content-under-image">
                            ...
                            <div class="fw-row ">
                                <img class="vector-line-1" src="./images/Vector-upper-arrow.png" />
                            </div>
                            ...
                            <div class="fw-row">
                                <div class="fw-container ">
                                    <div class="fw-col-md-4 vector-class">
                                        <div class="dot-1"></div>
                                        <div class="dot-2"></div>
                                        <img class="vector-cross-1" src="./images/vector.png" />
                                        <div class="dot-3"></div>
                                        <div class="dot-4"></div>
                                    </div>
                                    ...
                                    <div class="fw-col-md-4">
                                        <div class="fw-heading fw-heading-h2">
                                            <h2 class='fw-special-title vector-heading'>OUR PORTFOLIO
                                            </h2>
                                        </div>
                                    </div>
                                    <div class="fw-col-md-4  vector-class">
                                        <div class="dot-5"></div>
                                        <div class="dot-6"></div>
                                        <img class="vector-cross-2" src="./images/vector.png" />
                                        <div class="dot-7"></div>
                                        <div class="dot-8"></div>
                                    </div>
                                </div>
                            ...
                            <div class="fw-row ">
                                <img class="vector-line-2" src="./images/Vector-upper-arrow.png" />
                            </div>
                            <div class="fw-row">
