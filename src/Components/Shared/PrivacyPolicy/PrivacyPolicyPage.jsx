                                ...
                                <div className="fw-container ">
                                    ...
                                    <div className="fw-col-md-4">
                                        <div className="fw-heading fw-heading-h2">
                                            <h2 className='fw-special-title vector-heading'>Privacy Policy
                                            </h2>
                                        </div>
                                    </div>
                                    <div className="fw-col-md-4  vector-class">
            ...
            <section>
                <div className="privacy_policy_wepper">
                    ...
                    <div className="privacy_policy_inner">
                        ...
                        <ul>
                            <li><strong>Data Provided by You: Name, email, phone number, country, Skype ID, or other details you choose to share.</strong></li>
                            <li><strong>Cookies: Cookies track website usage to improve your experience. You may adjust your browser settings to disable cookies.</strong></li>
                            <li><strong>External Tools: Social plugins (Facebook, LinkedIn, etc.) for user interaction and engagement.</strong></li>
                        </ul>
                    </div>
                    <div className="privacy_policy_inner">
                    ...
                    <div className="privacy_policy_inner">
                        ...
                        <ul>
                            ...
                            <p>To exercise your rights, contact <a href="https://ishivax.com/" target="_blank">ishivax.com</a>.</p>
                        </ul>
                    </div>
                    <div className="privacy_policy_inner">
